...
def generate_launch_description():
    ...
    pkg = get_package_share_directory('low_level_control')
    ...
    cube_description_package_name = "low_level_control"
    cube_install_dir = get_package_prefix(cube_description_package_name)

    #plugin_package_name = "plugin_pkg"
    #plugin_install_dir = get_package_prefix(plugin_package_name)
    ...
    if 'GAZEBO_PLUGIN_PATH' in os.environ:
        os.environ['GAZEBO_PLUGIN_PATH'] + ':' + ur_install_dir + '/lib' + ':' + os.environ['GAZEBO_PLUGIN_PATH'] + ':' + cube_install_dir + '/lib'# + ':' + os.environ['GAZEBO_PLUGIN_PATH'] + ':' + plugin_install_dir + '/lib'
    else:
        os.environ['GAZEBO_PLUGIN_PATH'] = ur_install_dir + '/lib' + ':' + cube_install_dir + '/lib' # + ':' + plugin_install_dir + '/share/plugin_pkg/'
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            'world',
            default_value=os.path.join(pkg, 'worlds', 'box_plugin.world'),
            description='SDF world file'
        ),
        DeclareLaunchArgument(
            'gui',
            default_value='true',  # Set to 'false' to disable GUI by default
            description='Set to "true" to enable gzclient (GUI)'
        ),
        gazebo
    ])
